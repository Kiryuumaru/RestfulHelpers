...
public class IntegrationTest1
{
    ...
    public async Task GetWebResourceRootReturnsOkStatusCode()
    {
        ...
        Assert.Equal("ERROR_CODE_123", resultErrorResponse.Error.Code);
        ...
        Assert.Equal(HttpStatusCode.InternalServerError, httpResultErrorResponse.StatusCode);
        Assert.False(httpResultErrorResponse.IsSuccess);
        Assert.True(httpResultErrorResponse.IsError);
        Assert.Equal("ERROR_CODE_123", httpResultErrorResponse.Error.Code);
        ...
        Assert.Contains("WWW-Authenticate", httpResultErrorUnauthorizedResponse.ResponseHeaders.Keys);
        Assert.Contains("Bearer1", httpResultErrorUnauthorizedResponse.ResponseHeaders["WWW-Authenticate"]);
        Assert.Contains("Bearer2", httpResultErrorUnauthorizedResponse.ResponseHeaders["WWW-Authenticate"]);
    }
}
